...
class TellTaleWidget(QWidget):
    ...
    def play_chime_once(self):
        if self.chime_player:
            ...
            logger.debug(f"Chime played ONCE - Deck: {self.deck_num}, Card: {self.card_num}")
    ...
    def play_chime_twice(self):
        if self.chime_player:
            ...
            self.chime_player.setPosition(0)
            self.chime_player.play()
            logger.debug(f"Chime played TWICE (first) - Deck: {self.deck_num}, Card: {self.card_num}")
    ...
    def _play_chime_twice_second(self):
        if self.chime_player:
            ...
            self.chime_player.setPosition(0)
            self.chime_player.play()
            logger.debug(f"Chime played TWICE (second) - Deck: {self.deck_num}, Card: {self.card_num}")
    ...
    def play_chime(self):
        if self.chime_player:
            ...
            self.chime_player.setPosition(0)
            self.chime_player.play()
            logger.debug(f"Chime played (continuous) - Deck: {self.deck_num}, Card: {self.card_num}")
